		...
		if @order.save
			...
			Pony.mail(
			      ...
			      :body => "<table width='600' align='center' style='font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #666; line-height: 26px; text-align: justify;'>  
			      	...
			      	<tr>
			      		<td><img src='http://keynotestore.herokuapp.com/public/images/spacer.png'></td>
			      	</tr>
			      	<tr>  
			      	...
			      	<tr>  
			      		<td><a href='http://keynotestore.herokuapp.com/order/#{@order.order_number}/#{@order.id}'><img src='http://keynotestore.herokuapp.com/public/images/button-email-order.png' alt='Your Order.'></a></td>  
			      	</tr>
			      	<tr>
			      		<td><img src='http://keynotestore.herokuapp.com/public/images/spacer.png'></td>
			      	</tr>
